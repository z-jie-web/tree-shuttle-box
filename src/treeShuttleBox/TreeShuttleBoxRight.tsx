...
const TreeShuttleBoxRight: FC<TreeShuttleBoxRightPropsType> = ({}) => {
  ...
  console.log(readOnlyDataSourceRight, 'readOnlyDataSourceRightreadOnlyDataSourceRight')
  console.log(readOnlyAllKeyRight, 'readOnlyAllKeyRightreadOnlyAllKeyRight')
